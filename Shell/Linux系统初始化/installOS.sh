...
yum install -y tree  wget bash-completion vim java socat git bash-completion-extras  lrzsz net-tools sysstat iotop iftop htop unzip  telnet  ntpdate >/dev/null
